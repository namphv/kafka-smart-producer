...
class AsyncPartitionHealthMonitor:
    ...
    def embedded(
        ...
        Delegates to health_factory.create_async_embedded_monitor().
        See health_factory module for implementation details.

        Note: This is a sync classmethod that returns the monitor synchronously.
        For async creation, import create_async_embedded_monitor directly.
        """
        from .health_factory import create_async_embedded_monitor

        # embedded() is sync for backward compatibility
        # The factory handles initialization synchronously
        manager = cls(
    ...
    async def standalone(
        ...
        Delegates to health_factory.create_async_standalone_monitor().
        See health_factory module for implementation details.
        """
        from .health_factory import create_async_standalone_monitor

        return await create_async_standalone_monitor(
            consumer_group,
            kafka_config,
            topics,
            health_threshold,
    ...
    def from_config(
        ...
        Delegates to health_factory.create_async_monitor_from_config().
        See health_factory module for implementation details.
        """
        from .health_factory import create_async_monitor_from_config

        return create_async_monitor_from_config(health_config, kafka_config)
